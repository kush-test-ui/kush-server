[
  {
    ...
    "secrets": [
      ...
      {"name": "STRIPE_SECRET_KEY", "valueFrom": "/backend/${environment}/STRIPE_SECRET_KEY"},
      {"name": "STRIPE_PUBLIC_KEY", "valueFrom": "/backend/${environment}/STRIPE_PUBLIC_KEY"},
      {"name": "STRIPE_WEBHOOK_SECRET", "valueFrom": "/backend/${environment}/STRIPE_WEBHOOK_SECRET"},
